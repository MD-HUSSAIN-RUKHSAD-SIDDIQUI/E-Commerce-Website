...
if(isset($_POST['submit'])){
	...
	$expected_on = date('Y-m-d', strtotime($added_on.'+5 days'));
	
	$txnid = substr(hash('sha256', mt_rand() . microtime()), 0, 20);
		
	
	mysqli_query($con,"insert into `order`(user_id,address,city,pincode,payment_type,payment_status,order_status,added_on,expected_on,total_price,txnid) values('$user_id','$address','$city','$pincode','$payment_type','$payment_status','$order_status','$added_on','$expected_on','$total_price','$txnid')");
